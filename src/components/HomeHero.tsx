export default function HomeHero(){
  return <>
    <header className="site-header home-nav">
      ...
      <nav>
        ...
        <a href="/cbam-hs-code-list">CN Codes</a>
        <a href="/cbam-assessment-report">Report</a>
        <a href="/pricing">Pricing</a>
        <a href="/cbam-guide">Guides</a>
      </nav>
      <a className="header-cta" href="/cbam-calculator">Open Calculator <span>→</span></a>
      <details className="mobile-menu">
        ...
        <div>
          ...
          <a href="/hs-code-checker">HS Code Checker</a>
          <a href="/cbam-hs-code-list">CN Codes</a>
          <a href="/cbam-assessment-report">Report workflow</a>
          <a href="/pricing">Pricing</a>
          <a href="/cbam-guide">Guides</a>
        </div>
      </details>
    ...
    <section className="hero home-hero-v3">
      ...
      <div className="hero-inner">
        <div className="eyebrow"><span></span> EU CBAM WORKSPACE</div>
        <h1>From product code<br/>to <span>CBAM cost.</span></h1>
        <p>Screen product coverage, model certificate exposure and turn your inputs into a structured assessment report — in one practical workflow.</p>
      ...
      <div className="hero-panel workflow-panel">
        ...
        <div className="workflow-step"><span>02</span><div><small>MODEL</small><b>Estimate CBAM cost</b></div><em>→</em></div>
        <div className="workflow-step"><span>03</span><div><small>DOCUMENT</small><b>Create assessment report</b></div><em>✓</em></div>
        <div className="panel-result"><small>START HERE</small><strong>Know your product code?</strong><p>Screen it first, then carry the result into the calculator.</p></div>
