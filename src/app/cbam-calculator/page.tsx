  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-20">
      ...
      <p className="mt-4 text-gray-600">
        Estimate your potential EU Carbon Border Adjustment Mechanism impact.
      </p>
      ...
      <div className="mt-8 grid gap-4 max-w-xl">
        ...
        <button className="bg-blue-600 text-white rounded p-3" onClick={calculate}>
          Calculate
        </button>
      </div>
      ...
      {result !== null && (
        <div className="mt-8 border rounded p-6">
          <h2 className="text-2xl font-semibold">Estimated CBAM Cost</h2>
          <p className="mt-2">€ {result.toLocaleString()}</p>
        </div>
      )}
    </main>
  );
